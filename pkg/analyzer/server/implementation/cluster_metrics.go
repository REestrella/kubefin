...
func QueryClusterResourcesSummaryWithTimeRange(tenantId, clusterId string,
	resourceType v1.ResourceName, start, end, stepSeconds int64) (*types.ClusterResourceMetrics, error) {
...
func QueryAllClustersBasicProperty(tenantId string, start, end int64) (map[string]*types.ClusterBasicProperty, error) {
	var err error
...
func QueryClusterBasicProperty(tenantId, clusterId string, start, end int64) (*types.ClusterBasicProperty, error) {
	var err error
...
func ParseClusterBasicProperty(clusterActiveTime *model.Sample, clusterLasterActive *model.Sample) *types.ClusterBasicProperty {
	...
	return &types.ClusterBasicProperty{
		ClusterId:             clusterId,
...
func ParseMultiClustersBasicProperty(clusterActiveTime []*model.Sample, clusterLasterActive []*model.Sample) map[string]*types.ClusterBasicProperty {
	clustersInfo := make(map[string]*types.ClusterBasicProperty)
...
func ConvertToMultiClustersCostsList(clustersSummary map[string]*types.ClusterCostsSummary, clustersProperty map[string]*types.ClusterBasicProperty) *types.ClusterCostsSummaryList {
	for clusterId := range clustersSummary {
		clustersSummary[clusterId].ClusterBasicProperty = *clustersProperty[clusterId]
	}

	retList := &types.ClusterCostsSummaryList{}
...
func QueryAllClustersCurrentMetrics(tenantId string) (map[string]*types.ClusterResourcesSummary, error) {
	...
	ret := make(map[string]*types.ClusterResourcesSummary)
...
func parseAllClustersNodesNumber(data map[string]*types.ClusterResourcesSummary,
	...
	for clusterId, v := range nodesNumber {
		...
		data[clusterId] = &types.ClusterResourcesSummary{
...
func parseAllClustersPodsNumber(data map[string]*types.ClusterResourcesSummary,
...
func parseAllClustersResourceTotal(data map[string]*types.ClusterResourcesSummary,
...
func parseAllClustersResourceUsage(data map[string]*types.ClusterResourcesSummary,
...
func parseAllClustersResourceRequest(data map[string]*types.ClusterResourcesSummary,
...
func parseAllClustersResourceAvailable(data map[string]*types.ClusterResourcesSummary,
...
func parseAllClustersResourceSystemTaken(data map[string]*types.ClusterResourcesSummary,
...
func ConvertToMultiClustersResourcesList(clusterMetrics map[string]*types.ClusterResourcesSummary, clustersProperty map[string]*types.ClusterBasicProperty) *types.ClusterResourcesSummaryList {
	...
	retList := &types.ClusterResourcesSummaryList{}
...
func QueryClusterCurrentResources(tenantId, clusterId string) (*types.ClusterResourcesSummary, error) {
	...
	ret := &types.ClusterResourcesSummary{}
...
func parseClusterNodesNumber(data *types.ClusterResourcesSummary, nodesNumber map[string]int64) {
...
func parseClusterPodsNumber(data *types.ClusterResourcesSummary, podsNumber map[string]int64) {
...
func parseClusterResourceTotal(data *types.ClusterResourcesSummary, resourceTotal map[string]float64) {
...
func parseClusterResourceUsage(data *types.ClusterResourcesSummary, resourceUsage map[string]float64) {
...
func parseClusterResourceRequest(data *types.ClusterResourcesSummary, resourceRequest map[string]float64) {
...
func parseClusterResourceAvailable(data *types.ClusterResourcesSummary, resourceAvailable map[string]float64) {
...
func parseClusterResourceSystemTaken(data *types.ClusterResourcesSummary, resourceSystemTaken map[string]float64) {
