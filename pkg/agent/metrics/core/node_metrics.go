...
func (n *nodeMetricsCollector) getNodeCostInfo(nodeName string) (*types.InstancePriceInfo, error) {
...
func (n *nodeMetricsCollector) registerNodeResourceEventHandler(coreResourceInformerLister *options.CoreResourceInformerLister) {
